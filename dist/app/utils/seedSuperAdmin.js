...
const seedSuperAdmin = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hashedPassword = yield bcryptjs_1.default.hash(env_1.envVariables.SUPER_ADMIN_PASSWORD, Number(env_1.envVariables.BCRYPT_SALT_ROUND));
        const payload = {
            name: "Super admin",
            ...
            pin: hashedPassword,
            isVerified: true,
            phone: env_1.envVariables.SUPER_ADMIN_PHONE,
            nid: "8274567891",
            isDeleted: false,
